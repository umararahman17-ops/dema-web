...
export default function ProfilPage() {
  return (
    <>
        ...
        <div className="container">
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '50px', alignItems: 'center' }}>
            <div>
              ...
              <h2 style={{ fontSize: '2.2rem', fontWeight: 800, color: '#102619', marginBottom: '20px' }}>Lembaga Eksekutif Tertinggi Mahasiswa</h2>
              <p style={{ fontSize: '1.02rem', lineHeight: 1.8, color: '#44594c', marginBottom: '16px' }}>
              ...
              <p style={{ fontSize: '0.95rem', lineHeight: 1.8, color: '#5b7365' }}>
            ...
            <div style={{ background: 'linear-gradient(135deg, #f0f7f2 0%, #e3eee6 100%)', borderRadius: 'var(--radius-lg)', padding: '40px', border: '1px solid #d4e5d9', boxShadow: 'var(--shadow-sm)' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '14px', marginBottom: '20px' }}>
                ...
                <div>
                  ...
                  <h3 style={{ fontSize: '1.35rem', fontWeight: 800, color: '#11281c' }}>Visi Kabinet Sinergi Inovasi</h3>
                </div>
              </div>
              <p style={{ fontSize: '1.05rem', fontStyle: 'italic', color: '#1e452c', lineHeight: 1.7, marginBottom: '24px' }}>
              ...
              <h4 style={{ fontSize: '1.05rem', fontWeight: 800, color: '#11281c', marginBottom: '12px' }}>Misi Strategis:</h4>
              <ul style={{ display: 'flex', flexDirection: 'column', gap: '10px', fontSize: '0.92rem', color: '#3c5445' }}>
      ...
      <section style={{ padding: '80px 0', background: '#f4f8f5', borderTop: '1px solid #e2ede5' }}>
        <div className="container">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '360px 1fr', gap: '50px', alignItems: 'center' }}>
            {/* Logo Showcase Box */}
            <div style={{ background: '#ffffff', borderRadius: '28px', padding: '40px', boxShadow: 'var(--shadow-md)', border: '1px solid #dbe8df', textAlign: 'center' }}>
              <img src="/logo.png" alt="Logo DEMA" style={{ width: '200px', height: '200px', margin: '0 auto 24px', objectFit: 'contain' }} />
              <h3 style={{ fontSize: '1.3rem', fontWeight: 800, color: '#11281c' }}>Lambang Resmi DEMA</h3>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
              {logoPhilosophy.map((philo, index) => (
                <div key={index} style={{ background: '#ffffff', padding: '24px', borderRadius: 'var(--radius-md)', border: '1px solid #dbe8df', boxShadow: 'var(--shadow-sm)' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '12px' }}>
                    <div className={`philosophy-icon ${philo.color}`}>{philo.icon}</div>
                    <h4 style={{ fontSize: '1.05rem', fontWeight: 800, color: '#11281c' }}>{philo.title}</h4>
                  </div>
                  <p style={{ fontSize: '0.88rem', lineHeight: 1.6, color: '#4e6657' }}>{philo.desc}</p>
                </div>
              ))}
            </div>
          </div>
