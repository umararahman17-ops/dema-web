export const orgInfo = {
  ...
  period: '2026/2027',
  tagline: 'Menyatukan Inovasi Sains & Aksi Nyata untuk Perubahan Berkelanjutan',
  motto: 'Inovatif, Progresif, Kolaboratif, Berdampak',
  email: 'sekretariat@dema-univ.ac.id',
  phone: '+62 812-3456-7890',
  address: 'Gedung Student Center Lt. 2, Sayap Timur, Kampus Sains & Teknologi, Jl. Sains & Teknologi No. 45',
  instagram: '@dema.official',
  linkedin: 'DEMA Official Student Board',
  youtube: 'DEMA Channel Official',
};

export const stats = [
  { number: 8, suffix: '', label: 'Departemen & Biro', icon: '🏛️', color: 'green' },
  { number: 42, suffix: '+', label: 'Program Kerja Terlaksana', icon: '🚀', color: 'orange' },
  { number: 5400, suffix: '+', label: 'Mahasiswa Terfasilitasi', icon: '👥', color: 'green' },
  { number: 24, suffix: '+', label: 'Mitra Kampus & Industri', icon: '🤝', color: 'orange' },
];
...
export const logoPhilosophy = [
  {
    ...
    desc: 'Melambangkan pilar keilmuan, riset ilmiah yang tajam, dan pemikiran rasional analitis mahasiswa sebagai kaum intelektual.'
  },
  {
    icon: '⚙️',
    color: 'orange',
    title: 'Roda Bergerigi (Teknologi & Aksi)',
    desc: 'Simbol penerapan teknologi, dinamika kerja yang tidak pernah berhenti, dan implementasi nyata solusi teknik bagi peradaban.'
  },
  {
    icon: '🌿',
    color: 'green',
    title: 'Bingkai Segi Delapan Teranyam',
    desc: 'Representasi keteguhan integritas moral, keharmonisan persatuan antar elemen, serta sinergi kokoh lintas disiplin ilmu.'
  },
  {
    icon: '🔺',
    color: 'orange',
    title: 'Pilar Oranye & Sudut Maju',
    desc: 'Melambangkan gelora semangat regenerasi kepemimpinan, keberanian menatap tantangan zaman, dan arah pergerakan yang progresif.'
  }
];
